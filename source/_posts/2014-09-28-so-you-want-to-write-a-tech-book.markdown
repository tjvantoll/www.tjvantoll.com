...
> That stat is from Ilya's [amazing retrospective of his work on the book](https://www.igvita.com/2013/09/29/retrospective-high-performance-browser-networking/). You should read it, especially if you're interested in detailed data related to the writing process.
...
<p>
	...
	<i>See, it is 361 pages. Manning counts the index pages so I will too.</i>
</p>
...
I have mixed feelings about having this much ceremony to put out a book. On the positive side I have never been more proud of anything I've written in my life. I made a number of beneficial changes to the structure and contents of the book based on the external reviews. Later I was ecstatic that [Jörn Zaefferer](http://bassistance.de/) agreed to tech review the book. And I learned a lot from going through the copy editing process.
...
This tip isn't for everyone, but for some a drink or two can help but your mind at ease and help get words onto paper. (Figuratively of course, if you're literally writing random words on physical paper that's a sign that you've had too many.) Personally I found that the occasional beer could help my creative processes substantially.
...
The theme of the previous tips was to help produce a first draft as fast as possible, and this is a continuation of that message. Simply put, while writing a first draft, don't worry about your grammar. Don't know whether to write “it's” or “its”? Don't worry about it while you're cranking out the first draft.
...
The stresses and timelines associated with writing a book can make you feel like you need to write every day no matter what. But writer's block is a real thing, and some days it's impossible to write words no matter how hard you try. And nights where you spend hours accomplishing nothing are extremely detrimental to your morale. You wake up the next day tired and even more stressed out from the time you just lost.

Over time I started giving up on days where I knew nothing would happen and to go to sleep. I did this not only for the obvious benefit of being more rested the next day, but because I also found sleeping to help with the my creative processes. I can think of several occasions that I had no idea how to approach a certain topic, but I woke up with a couple of good ideas.
...
jQuery UI has a lot of good 101 material scattered throughout the web, but nothing that I felt did the library justice, and I felt that I was in a unique position—as a team member and tech writer—to make the guide I wanted to exist a reality.

My desire to share this information is what gave me the motivation to keep going. If I set out to write a 101-level book on jQuery UI I would've lost my sanity by week three. People frequently ask me if I'll write another book, and my answer is that I will if I have a topic compelling enough to spend a year of my life on—aka something pretty damn compelling.
...
An even cooler, and somewhat surreal moment happened the following month when [Amazon sent me an email that recommended my book to me](https://twitter.com/tjvantoll/status/521996479314296832). It was also cool when I [randomly discovered that *jQuery UI in Action* had four 5-star reviews on its Amazon page](https://twitter.com/tjvantoll/status/536549375670231040)
...
Now I'm certainly not an expert on any of these topics, but I'm far more knowledgeable than I was when I started, and that's kind of cool. Even if you're a coder, writing effectively is still an incredibly valuable skill—even if you're just using it to argue for tabs over spaces in a GitHub comment.
