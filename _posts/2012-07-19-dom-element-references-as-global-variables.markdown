...
Believe it or not this is actually correct behavior [per the HTML specification](http://www.whatwg.org/specs/web-apps/current-work/#named-access-on-the-window-object).
...
Per [this portion of the spec](http://dev.w3.org/html5/spec/single-page.html#dom-window-nameditem):
...
<pre class="language-markup"><code class="language-markup">&lt;div id="foo"&gt;&lt;/div&gt;
&lt;script&gt;
    (function() {
        'use strict';
        console.log(foo);
...
<pre class="language-markup"><code class="language-markup">&lt;button id="foo"&gt;&lt;/button&gt;
...
<pre class="language-markup"><code class="language-markup">&lt;a name="bar"&gt;&lt;/a&gt;
